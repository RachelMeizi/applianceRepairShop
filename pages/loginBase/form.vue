		...
		<form>
			<view class="userInfo-view">
				<view class="">
					...
					<text class="title_desc" v-if="pages==2">向boss介绍一下自己</text>
					<text class="title_desc" v-if="pages==1">向师傅求助</text>
				</view>
			</view>
			<view class="userInfo-headurl" @tap="ChooseImage">
				<view class="">
					<text class="titleTop">头像</text>
					<text class="title_desc">上传照片</text>
				</view>
				<image style="width:100upx;height: 100upx;border-radius: 50%;" src="../../static/logo.png" mode=""></image>
			</view>
				...
				<view class="cu-form-group margin-top">
					...
					<view class="uni-padding-wrap">
						<radio-group @change="radioChange">
							<label class="radio">
								<radio value="1" color='#31C8B8' checked="true" />男</label>
							<label class="radio">
								<radio value="2" color='#31C8B8' />女</label>
						</radio-group>
					</view>
				</view>
