		...
		<view class="category-list">
			...
			<scroll-view  scroll-y="true" class="right" >
			    <view class="category" v-for="(category,index) in categoryList" :key="category.id" v-show="index==showCategoryIndex" >
					<view class="banner">
						<image :src="category.ico"></image>
					</view>
					<view class="list">
						<view class="box" v-for="(box,i) in category.list" :key="i" @tap="toCategory(box,category)">
							<image :src="box.ico"></image>
	...
	export default {
		data() {
			return {
				...
				categoryList:[],
				// categoryList:[
				// 	{id:1,title:'家用电器',banner:'https://ss1.bdstatic.com/70cFvXSh_Q1YnxGkpoWK1HF6hhy/it/u=1275117093,2668160548&fm=26&gp=0.jpg',list:[
				// 		{ id:2,title:'冰箱',	img:'1.jpg'},
				// 		{id:3,title:'电视',	img:'2.jpg'},
				// 		{id:4,title:'空调',	img:'3.jpg'},
				// 		{id:5,name:'洗衣机',	img:'4.jpg'},
				// 		{id:6,name:'风扇',	img:'5.jpg'},					
				// 	]},
		...
		methods: {
			...
			toCategory(sid,fid){
				...
				uni.navigateTo({
					url: '/pages/shopMall/goodsList/goodsList?fid='+fid.id+'&sid='+sid.id
				});
			},
			//搜索跳转
			toSearch(){
