<template>
    <view class="neil-modal" @touchmove.stop.prevent="bindTouchmove" :class="{'neil-modal--show':isOpen}">
        <view class="neil-modal__mask" @click.stop="clickMask"></view>
        <view class="neil-modal__container">
            ...
            <view class="neil-modal__footer">
                <view v-if="showCancel" class="neil-modal__footer-left" @click.stop="clickLeft" :style="{color:cancelColor}"
                    hover-class="neil-modal__footer-hover" :hover-start-time="20" :hover-stay-time="70">
                    {{cancelText}}
                </view>
                <view class="neil-modal__footer-right" @click.stop="clickRight" :style="{color:confirmColor}" hover-class="neil-modal__footer-hover"
